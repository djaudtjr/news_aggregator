...
export function NewsCardList({ article }: NewsCardListProps) {
    ...
    <Card className="flex flex-row overflow-hidden transition-all hover:shadow-lg">
      ...
      <div className="flex flex-col flex-1">
        ...
        <CardFooter className="flex gap-2">
          <Button variant="outline" className="bg-transparent" onClick={handleSummarize} disabled={isLoading || !!summary}>
